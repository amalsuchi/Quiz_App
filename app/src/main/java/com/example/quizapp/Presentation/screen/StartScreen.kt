...
fun StartScreen(navController: NavController,viewModel: QuizViewModel){
    ...
    Column(modifier = Modifier.fillMaxSize().background(backgroundBlue), horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center) {
